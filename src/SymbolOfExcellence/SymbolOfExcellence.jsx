    ...
    return(
        <>
            <div style={{height:"20rem",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"20px"}}>
                ...
                <SpecialDiv style={{display:"flex",alignItems:"center",justifyContent:"center"}}>
                    <div style={{textAlign:"center",color:"grey",fontFamily:"Work-Sans,sans-serif",display:"flex",alignItems:"center",lineHeight: "1.5",fontSize:"120%"}}>
